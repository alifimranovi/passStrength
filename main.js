...
password.addEventListener('input', () => {
    ...
    }else if (password.value.length >= 8 && password.value.includes('!') || password.value.includes('@') || password.value.includes('?') || password.value.includes('#') || password.value.includes('$')) {
